...
const enterpriseEn: EditorialPageCopy = {
  ...
  sections: [
    ...
    { id: 'deploy', aliases: ['grow'], no: '05', label: 'START WHERE VALUE IS VISIBLE', title: 'One property first.', accent: 'Evidence before expansion.', body: 'Begin with verified knowledge and a bounded guest journey. Add integrations where they improve the measure, then expand property by property.', tone: 'paper', presentation: 'flow', items: [
      { title: 'Agree', body: 'Select the property, journey and measures.' }, { title: 'Prepare', body: 'Verify knowledge, voice, owners and boundaries.' }, { title: 'Operate', body: 'Run live with weekly briefings and a Day-45 review.' }, { title: 'Decide', body: 'At Day 90, the agreed evidence determines what comes next.' },
    ], note: 'FOUNDING PILOT · TIMELINE AND SCOPE ARE AGREED WITH EACH PARTICIPANT', link: { href: '/contact#founding', label: 'See the founding pilot' } },
  ],
...
const enterpriseEs: EditorialPageCopy = {
  ...
  sections: [
    ...
    { ...enterpriseEn.sections[4], label: 'COMIENZA DONDE EL VALOR ES VISIBLE', title: 'Primero una propiedad.', accent: 'Evidencia antes de expandir.', body: 'Inicia con conocimiento verificado y una experiencia acotada. Integra donde mejore la medida y expande propiedad por propiedad.', items: [
      { title: 'Acordar', body: 'Elegir propiedad, experiencia y medidas.' }, { title: 'Preparar', body: 'Verificar conocimiento, voz, responsables y límites.' }, { title: 'Operar', body: 'Trabajar en vivo con informes semanales y revisión al Día 45.' }, { title: 'Decidir', body: 'Al Día 90, la evidencia acordada define el siguiente paso.' },
    ], note: 'PILOTO FUNDADOR · CRONOGRAMA Y ALCANCE SE ACUERDAN CON CADA PARTICIPANTE', link: { href: '/contact#founding', label: 'Ver el piloto fundador' } },
  ],

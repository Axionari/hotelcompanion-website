...
const en = {
  ...
  model: {
    ...
    nodeTitle: 'Companion Operating System',
    nodeSub: 'ONE SHARED LAYER OF ORGANIZATIONAL INTELLIGENCE',
    toRecipients: 'SHARED ACROSS THE ORGANIZATION',
    recipients: ['People', 'Teams', 'Systems', 'Operations'],
    toOutcomes: 'WHICH IMPROVES',
    outcomes: ['Better experiences', 'Better decisions', 'Stronger operations', 'Compounding knowledge'],
    loop: 'AND EVERY OUTCOME SHARPENS THE NEXT INTERACTION',
  },
...
const es: typeof en = {
  ...
  model: {
    ...
    nodeTitle: 'Companion Operating System',
    nodeSub: 'UNA SOLA CAPA COMPARTIDA DE INTELIGENCIA ORGANIZACIONAL',
    toRecipients: 'COMPARTIDA EN TODA LA ORGANIZACIÓN',
    recipients: ['Personas', 'Equipos', 'Sistemas', 'Operaciones'],
    toOutcomes: 'LO QUE MEJORA',
    outcomes: ['Mejores experiencias', 'Mejores decisiones', 'Operaciones más sólidas', 'Conocimiento que se acumula'],
    loop: 'Y CADA RESULTADO AFINA LA SIGUIENTE INTERACCIÓN',
  },
  /* Capability deep-dives — all eight, in canonical taxonomy order. */
  deepDives: [
    {

  ...
  return (
    <div className="suite-wrap" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      ...
      <div
        ...
        style={{ width: '100%', ...titaniumFrame({ radius: 26, bezel: 12, drop: '0 60px 130px -34px rgba(0,0,0,0.85)' }) }}
      >
        <div className="suite-screen" style={{ height: '100%', borderRadius: 14, overflow: 'hidden', background: 'radial-gradient(120% 100% at 30% 0%, #17130f 0%, #100e0c 60%, #0c0b0a 100%)', boxShadow: titaniumScreenShadow(), display: 'flex', flexDirection: 'column' }}>
